...
import com.njk.R;
import com.njk.photo.adapter.AlbumGridViewAdapter;
import com.njk.photo.util.AlbumHelper;
import com.njk.photo.util.Bimp;
import com.njk.photo.util.ImageBucket;
...
//			overridePendingTransition(R.anim.activity_translate_in, R.anim.activity_translate_out);
			intent.setClass(mContext, SendPhotoActivity.class);
			startActivity(intent);
			finish();
		}
