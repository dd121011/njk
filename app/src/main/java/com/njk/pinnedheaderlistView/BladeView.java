...
public class BladeView extends View {
	private OnItemClickBladeListener mOnItemClickBladeListener;
	String[] b = {"定","热", "#", "A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K",
...
//			text = Character.toString((char) ('A' + item - 1));
	...
	public void setOnItemClickListener(OnItemClickBladeListener listener) {
		mOnItemClickBladeListener = listener;
	}

	private void performItemClicked(int item) {
		if (mOnItemClickBladeListener != null) {
			mOnItemClickBladeListener.onItemClick(b[item]);
			showPopup(item);
		}
	}

	public interface OnItemClickBladeListener {
