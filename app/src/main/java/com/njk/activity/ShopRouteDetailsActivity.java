 ...
 * 同时展示如何进行节点浏览并弹出泡泡
 */
//public class ShopRouteDetailsActivity extends BaseActivity implements BaiduMap.OnMapClickListener,
...
//        View rootView = LayoutInflater.from(this).inflate(R.layout.activity_routeplan, null);
//        setContentView(rootView);
//        Utils.showTopBtn(rootView, "线路搜索", TOP_BTN_MODE.SHOWBACK,"","");
...
//        // show popup
//        popupText = new TextView(ShopRouteDetailsActivity.this);
...
//            Toast.makeText(ShopRouteDetailsActivity.this, "抱歉，未找到结果", Toast.LENGTH_SHORT).show();
//        }
