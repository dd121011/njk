 ...
 * 同时展示如何进行节点浏览并弹出泡泡
 */
public class ShopRouteSearchActivity extends BaseActivity implements BaiduMap.OnMapClickListener,
    ...
    public void nodeClick(View v) {
        ...
        // show popup
        popupText = new TextView(ShopRouteSearchActivity.this);
    ...
    public void onGetWalkingRouteResult(WalkingRouteResult result) {
        if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
            Toast.makeText(ShopRouteSearchActivity.this, "抱歉，未找到结果", Toast.LENGTH_SHORT).show();
        }
