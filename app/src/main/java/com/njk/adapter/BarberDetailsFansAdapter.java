...
public class BarberDetailsFansAdapter extends BaseAdapter {
	...
	public BarberDetailsFansAdapter(Activity context, LinkedList mListItems) {
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		// TODO Auto-generated method stub
		if(arg1 == null){
			arg1 = LayoutInflater.from(context).inflate(R.layout.barber_fans_item_layout, null);
		}
		ImageView faceImg = (ImageView) arg1.findViewById(R.id.fan_img);
